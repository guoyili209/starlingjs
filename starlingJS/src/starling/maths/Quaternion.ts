module StarlingJS {
    export class Quaternion {
        ...
        */
        clone() {
            var dest =/*__JS__ */new Quaternion();
            this.cloneTo(dest);
            return dest;
        }
        ...
        */
        ...
        static angleTo(from, location, angle) {
            Vector3D.subtract(location, from, Quaternion.TEMPVector30);
            Vector3D.normalize(Quaternion.TEMPVector30, Quaternion.TEMPVector30);
