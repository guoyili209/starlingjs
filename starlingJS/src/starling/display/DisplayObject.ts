module StarlingJS {
    export class DisplayObject extends EventDispatcher {
        ...
        /** @private */ private _lastParentOrSelfChangeFrameID: number;
        /** @private */ private _lastChildChangeFrameID: number;
        /** @private */ private _tokenFrameID: number;
        ...
        localToGlobal(localPoint: Point, out: Point | null = null): Point {
            if (this.is3D) {
                ...
                this.getTransformationMatrix(base, DisplayObject.sHelperMatrixAlt);
